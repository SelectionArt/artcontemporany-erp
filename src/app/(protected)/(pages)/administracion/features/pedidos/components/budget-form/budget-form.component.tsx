    ...
    <Form {...form}>
      ...
      >
        <div className="flex flex-col gap-4">
                ...
                <FormItem className="grow basis-1/3">
                  ...
                  <FormControl>
                    <AutoComplete
                      ...
                      onSearchValueChange={setSearchValueClient}
          ...
          <div className="grid grid-cols-[1fr_1fr_1fr] gap-2 sm:grid-cols-[1fr_1fr_1fr_1fr] md:grid-cols-[1fr_1fr_1fr_1fr_1fr_1fr_1fr]">
            <FormField
              control={form.control}
              name={constants.PAYMENT_METHOD_FIELD.inputProps.name}
              render={({ field }) => (
                <FormItem className="col-[1/3]">
            ...
            <FormField
              control={form.control}
              name={constants.SURCHARGE_FIELD.inputProps.name}
              render={({ field }) => (
                <FormItem className="grow basis-1/5">
                  <FormLabel {...constants.SURCHARGE_FIELD.labelProps}>
                    {constants.SURCHARGE_FIELD.labelText}
                  </FormLabel>
                  <FormControl>
                    <Input
                      {...{
                        ...field,
                        ...constants.SURCHARGE_FIELD.inputProps,
                        disabled: loading,
                      }}
                    />
                  </FormControl>
                  <FormMessage {...constants.SURCHARGE_FIELD.messageProps} />
                </FormItem>
              )}
            />
          </div>
