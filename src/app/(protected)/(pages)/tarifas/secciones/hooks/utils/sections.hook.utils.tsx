...
} from "./types/sections.hook.utils.types";

function getColumnsConfig({
  handleDelete,
  handleEdit,
}: GetColumnsConfigProps<Section>): GetColumnsConfigReturn<Section> {
  return [
    {
    ...
    },
    {
      accessorKey: "slug",
      header: ({ column }) => (
        <ColumnSorter column={column} label="Identificador de URL" />
      ),
      meta: "Identificador de URL",
    },
    {
      cell: ({ row }) => (
        <RowActions
